...
// Create a cache middleware instance with a maximum size of 1000 and hybrid options
const cache = new CacheMiddleware(1000, { strategy: 'LRU' });
...
cache.setCoherencyStrategy('write-behind');
